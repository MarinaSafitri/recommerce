...
app.get('/wooapi/getrekomendasi',function(req,res){
...
//   var shop1Arr = [];
//   session
//     .run('MATCH(n:Shop{token:{tokenParam}}) RETURN n', {tokenParam:token}) //edit smpe sini
//     .then(function(result){
//
//       result.records.forEach(function (record){
//         shop1Arr.push({
//           totalprod: record._fields[0].properties.totalprod,
//           totalcust: record._fields[0].properties.totalcust,
//           totalorder: record._fields[0].properties.totalorder,
//           urlshop: record._fields[0].properties.urlshop
//         });
...
app.get('/wooapi/tescurl',function (req,res){
  console.log(req.query.cs);
  res.end('selesai');
});
